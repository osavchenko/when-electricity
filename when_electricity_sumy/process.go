...
var schedules = map[string]map[int]map[int][][]int{
	...
	"+4:+2/-4": {
		1: {
			1: {{0, 2}, {6, 8}, {10, 14}, {16, 20}, {22, 24}},
			2: {{4, 6}, {8, 12}, {14, 18}, {20, 24}},
			0: {{2, 4}, {8, 10}, {12, 16}, {18, 22}},
		},
		2: {
			1: {{2, 4}, {8, 10}, {12, 16}, {18, 22}},
			2: {{0, 2}, {6, 8}, {10, 14}, {16, 20}, {22, 24}},
			0: {{4, 6}, {8, 12}, {14, 18}, {20, 24}},
		},
		3: {
			1: {{4, 6}, {8, 12}, {14, 18}, {20, 24}},
			2: {{2, 4}, {8, 10}, {12, 16}, {18, 22}},
			0: {{0, 2}, {6, 8}, {10, 14}, {16, 20}, {22, 24}},
		},
	},
	"+8:+2/-4": {
		1: {
...
func process(w http.ResponseWriter, r *http.Request) {
	...
	if msg.Text == "" {
		msg.Text = "Я вас не зрозумів, оберіть чергу відключень електроенергії"
		msg.ReplyMarkup = keyboard
	}
